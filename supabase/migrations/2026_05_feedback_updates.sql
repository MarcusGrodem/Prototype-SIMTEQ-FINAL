  ...
  if not exists (select 1 from public.report_templates where is_default) then
    ...
    insert into public.report_template_sections (template_id, section_key, title, body, position) values
      ...
      (t_id, 'sec_1_2', '1.2  Scope of Services Covered',
        E'This report covers the general IT controls and information security controls operated by {{company}} in connection with the following services provided to user entities:\n\n• Managed IT infrastructure services, including server hosting, network management, and endpoint management.\n• Cloud platform services, including provisioning, monitoring, and management of cloud environments (Azure, AWS).\n• IT security operations, including vulnerability management, patch management, and security monitoring.\n• Data management and backup services, including data storage, backup execution, and recovery testing.\n• Service desk and change management services for user entities.', 20),
      ...
      (t_id, 'sec_2_1', '2.1  Overview of {{company}}',
        E'{{company}} is a Norwegian IT services company headquartered in Norway. The company provides managed services, cloud solutions, and IT infrastructure support to a diverse customer base across private and public sector organizations. {{company}} employs a team of certified IT professionals dedicated to ensuring the availability, confidentiality, and integrity of the services it provides.\n\n{{company}} operates primary data center facilities in Norway, with redundant systems to ensure business continuity. All data processing and storage activities are conducted within the European Economic Area (EEA), in compliance with applicable data protection regulations.', 60),
